...
function RecommendSong({ track }) {
  return (
    <div className='flex flex-col items-center hover:bg-gray-900 transition duration-100 ease-out cursor-pointer py-5 rounded-xl'>
      <div>
        <img
      ...
      <h1 className='mt-2 w-30 text-xl'>{track.album?.name}</h1>
